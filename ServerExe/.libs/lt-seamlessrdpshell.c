...
/* ./.libs/lt-seamlessrdpshell.c - temporary wrapper executable for .libs/seamlessrdpshell.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-11

   The seamlessrdpshell program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "seamlessrdpshell.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# seamlessrdpshell - temporary wrapper script for .libs/seamlessrdpshell.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-11\n", f);
  fputs ("#\n", f);
  fputs ("# The seamlessrdpshell program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"seamlessrdpshell.exe:seamlessrdpshell:$LINENO: libtool wrapper (GNU l", f);
  fputs ("ibtool) 2.4.6 Debian-2.4.6-11\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"seamlessrdpshell.exe:seamlessrdpshell:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"seamlessrdpshell.exe:seamlessrdpshell:$LINENO: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='seamlessrdpshell.exe'\n", f);
