...
/* ./.libs/lt-seamlessrdphook64.c - temporary wrapper executable for .libs/seamlessrdphook64.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-11

   The seamlessrdphook64 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "seamlessrdphook64.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.6 Debian-2.4.6-11\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# seamlessrdphook64 - temporary wrapper script for .libs/seamlessrdphook64.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-11\n", f);
  fputs ("#\n", f);
  fputs ("# The seamlessrdphook64 program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"seamlessrdphook64.exe:seamlessrdphook64:$LINENO: libtool wrapper (GNU", f);
  fputs (" libtool) 2.4.6 Debian-2.4.6-11\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"seamlessrdphook64.exe:seamlessrdphook64:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"seamlessrdphook64.exe:seamlessrdphook64:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='seamlessrdphook64.exe'\n", f);
